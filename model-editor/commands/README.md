...
![](<../../.gitbook/assets/align (2).svg>) **Align**
...
![](<../../.gitbook/assets/auto-align (2).svg>) **Auto align**
...
![](<../../.gitbook/assets/merge-coplanar (3).svg>) **Join coplanar faces**
...
![](<../../.gitbook/assets/match-and-replace (1).svg>) **Match and replace rooms**
...
![](<../../.gitbook/assets/pull-to-room (2).svg>) **Pull to room**
...
![](<../../.gitbook/assets/remove-small-holes (2).svg>) **Remove holes**
...
![](<../../.gitbook/assets/remove-short-segments (2).svg>) **Remove short segments**
...
![](<../../.gitbook/assets/import-windows (1).svg>) **Import windows**
...
![](<../../.gitbook/assets/make-windows-flush (1).svg>) **Make windows flush**
...
![](<../../.gitbook/assets/offset-windows (2).svg>) **Offset windows for frame**
...
![](<../../.gitbook/assets/rectangularize-windows (1).svg>) **Rectangularize windows**
...
![](<../../.gitbook/assets/simplify-windows (2).svg>) **Simplify windows**
...
![](<../../.gitbook/assets/fill-holes-with-rooms (2).svg>) **Fill holes**
...
![](<../../.gitbook/assets/merge-with-filter (2).svg>) **Merge Small Rooms**
...
![](<../../.gitbook/assets/merge-rooms (2).svg>) **Merge rooms**
...
![](<../../.gitbook/assets/split-room (2).svg>) **Split**

Split rooms or roofs by the selected lines/polylines. [Read more](me_split.md).

![](<../../.gitbook/assets/core-pr (2).svg>) **Split core and perimeter**
...
![](<../../.gitbook/assets/separate-plenums (2).svg>) **Vertically split**
...
![](<../../.gitbook/assets/air-boundaries (2).svg>) **Set air boundaries**
...
![](<../../.gitbook/assets/solve-adjacency (2).svg>) **Solve adjacency**
...
![](<../../.gitbook/assets/unite-square-duotone (2).svg>) **Create boundary**
...
![](<../../.gitbook/assets/gen-align-axes (2).svg>) **Generate alignment axes**
...
![](<../../.gitbook/assets/validate-model (2).svg>) **Validate model**
...
![](<../../.gitbook/assets/create-room (2).svg>) **Create rooms**
...
![](<../../.gitbook/assets/find-adjacency-gaps (1).svg>) **Find roof gaps**

Identify gaps smaller than a specified gap distance. [Read more](me_find_roof_gaps.md).

![](<../../.gitbook/assets/int-roof (2).svg>) **Find roof intersection**
...
![](<../../.gitbook/assets/import-roofs (2).svg>) **Import roofs**
