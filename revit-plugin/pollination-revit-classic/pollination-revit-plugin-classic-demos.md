...
We have already recorded two separate demos for you that show the process. [One is only 15 minutes long](pollination-revit-plugin-classic-demos.md#id-15-minute-demo), and [the other is 40 minutes long](pollination-revit-plugin-classic-demos.md#id-40-minute-demo). There is also [a longer hands-on video tutorial series](pollination-revit-plugin-classic-demos.md#hands-on-tutorial) that walks you through every step of the process.

Finally, [there is a demo of the upcoming Revit plugin v3.0](pollination-revit-plugin-classic-demos.md#revit-plugin-v3.0-demo) that shows a demo of the upcoming version of the plugin.
...
If you're interested to more than just a demo, you should [check out the full hands on tutorial](hands-on-tutorial/). It is developed based on many workshops that we have taught during the last several years and walks you through every step of the process using the Revit advance sample model.

{% content-ref url="hands-on-tutorial/" %}
