...
{% embed url="https://youtu.be/yvyzjcKcWkM" %}

If you need the files, here are the files you'll need to follow along this section.

{% file src="../../../../.gitbook/assets/07-Revit Advanced Sample Model-Validated.pomf" %}

Here is a copy of the final model after validation.

{% file src="../../../../.gitbook/assets/08-Revit Advanced Sample Model-Shades-Added.pomf" %}
...
<figure><img src="../../../../.gitbook/assets/image(114).png" alt=""><figcaption><p>Revit sample model in Tas (.gbXML)</p></figcaption></figure>
