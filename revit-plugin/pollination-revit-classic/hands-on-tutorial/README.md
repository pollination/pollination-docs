# Hands on Tutorial: Exporting Revit Advanced Sample Model

{% hint style="info" %}
[Before starting this tutorial, you may want to ensure the Pollination Revit plugin is the right tool for you](../../getting-started.md).
{% endhint %}
...
{% embed url="https://youtu.be/ya3FCiRmQiA" %}
