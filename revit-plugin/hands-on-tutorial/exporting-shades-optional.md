...
{% embed url="https://youtu.be/Wao1qHikIxQ" %}
...
{% hint style="info" %}
This property only translates to DFJSON, HBJSON, and GEM file formats. Attached shades translate to local shades in IESVE.
{% endhint %}
